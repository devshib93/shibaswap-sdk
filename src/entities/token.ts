...
export const WETH = {
  ...
  [ChainId.POLYGON_AMOY]: new Token(ChainId.POLYGON_AMOY, '0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889', 18, 'WMATIC', 'Wrapped Matic'),
  [ChainId.LINEA_SEPOLIA]: new Token(ChainId.LINEA_SEPOLIA, '0x2C1b868d6596a18e32E61B901E4060C872647b6C', 18, 'WETH', 'Wrapped Ether'),
  [ChainId.SCROLL_SEPOLIA]: new Token(ChainId.SCROLL_SEPOLIA, '0x5300000000000000000000000000000000000004', 18, 'WETH', 'Wrapped Ether'),
  [ChainId.MANTLE_TESTNET]: new Token(ChainId.MANTLE_TESTNET, '0xDeadDeAddeAddEAddeadDEaDDEAdDeaDDeAD0000', 18, 'WMNT', 'Wrapped Mantle'),
  [ChainId.CELO_ALFAJORES]: new Token(ChainId.CELO_ALFAJORES, '0xF194afDf50B03e69Bd7D057c1Aa9e10c9954E4C9', 18, 'WCELO', 'Wrapped Celo'),
  ...
  [ChainId.GNOSIS_CHIADO]: new Token(ChainId.GNOSIS_CHIADO, '0xe91d153e0b41518a2ce8dd3d7944fa863463a97d', 18, 'WXDAI', 'Wrapped xDai')
}
